...
function About(){
  return(
    <div className="bg-[rgb(32,35,40)] rounded-[10px] pt-[20px] px-[50px] pb-[30px] mt-[40px] mb-[40px] text-[rgb(211,217,221)] shadow-[0_5px_10px_rgba(0,0,0,0.4)]" id="about">
      <h2 className="text-center text-white font-bold text-[40px] mb-[20px]">About</h2>
      <div className="text-center text-[32px] mb-[20px] px-[50px]">
      ...
      <div className="text-center mb-[40px]">
        <h3 className="text-white font-bold text-[32px] mb-2">Education</h3>
      ...
      <div className="text-center">
        <h3 className="text-white text-[32px] mb-4">Skills</h3>
