...
function Profile() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center pt-[150px] pb-[70px] relative bg-[url('/images/umichbackground.jpg')] bg-cover bg-center bg-no-repeat text-center md:text-left">
      <div className="text-white z-10 max-w-[600px]">
        ...
        <div className="flex justify-center md:justify-start gap-2 mt-1 text-[30px]">
      ...
      <img src={pic} className="rounded-full w-[300px] h-[300px] object-cover z-10 shadow-[0_5px_10px_rgba(0,0,0,0.3)] mt-[40px] md:mt-0 md:ml-[11%]" alt="profile"/>
    </div>
  );
}
