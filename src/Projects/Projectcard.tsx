  ...
  return(
    <div className="bg-[rgb(50,54,61)] h-[350px] sm:h-[300px] w-[400px] px-[20px] sm:px-[30px] pb-[20px] pt-0 sm:pt-[5px] rounded-[15px] mb-[20px] shadow-[0_4px_6px_rgba(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-[3px] hover:shadow-[0_6px_9px_rgba(0,0,0,0.4)]">
      <div className="flex justify-between items-center pt-[15px]">
        ...
        <div className="text-[27px] sm:text-[30px] mt-[10px] mr-[2px] text-[rgb(211,217,221)] flex gap-[15px]">
          {project.showGitHub && <a href={project.url} className="transition duration-300 hover:text-white hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]" target="_blank" rel="noopener noreferrer"><FaGithub /></a>}
          {project.showDemo && <button onClick={() => setModalOpen(true)} className="transition duration-300 hover:text-white hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]"><FaCirclePlay /></button>}
        </div>
      </div>
