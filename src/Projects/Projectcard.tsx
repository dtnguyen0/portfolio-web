...
function Projectcard(project: ProjectProps) {
  ...
  return(
    <div className="bg-[rgb(50,54,61)] h-[350px] sm:h-[250px] w-[400px] px-[20px] sm:px-[30px] pb-[20px] pt-0 sm:pt-[5px] rounded-[15px] mb-[20px] shadow-[0_4px_6px_rgba(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-[3px] hover:shadow-[0_6px_9px_rgba(0,0,0,0.4)]">
