...
function Projectcard(project: ProjectProps) {
  const icons = [project.img1, project.img2, project.img3, project.img4, project.img5, project.img6];
  
  return(
    <div className="bg-[rgb(50,54,61)] h-[250px] w-[400px] px-[30px] pb-[20px] pt-[5px] rounded-[15px] mb-[20px] shadow-[0_4px_6px_rgba(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-[3px] hover:shadow-[0_6px_9px_rgba(0,0,0,0.4)]">
      ...
      <div className="flex gap-2 mt-2">
        {icons
          .filter((src) => src)
          .map((src, index) => (<img key={index} src={src} alt="" className="w-[30px]" />))}
      </div>
