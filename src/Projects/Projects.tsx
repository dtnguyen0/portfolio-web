...
function Projects() {
  return(
    <div className="bg-[rgb(32,35,40)] rounded-[10px] pt-[30px] px-[40px] pb-[30px] mt-[40px] mb-[40px] text-[rgb(211,217,221)] shadow-[0_5px_10px_rgba(0,0,0,0.4)]" id="projects">
      <div>
        <h2 className="text-center text-white font-bold text-[40px] mb-[20px]">Projects</h2>
