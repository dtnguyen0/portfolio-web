      ...
      <div>
        <h2 className="text-center text-white font-bold text-[32px] sm:text-[40px] mb-[20px]">Projects</h2>
          <div className="flex flex-wrap justify-center gap-[20px] mt-[5%]"> 
            <Projectcard showGitHub={false} showDemo={false} name="Trading Bot"
            ...
            <Projectcard showGitHub={true} showDemo={false} name="Ineedio" url="https://github.com/Ineed-io/web"
            ...
            <Projectcard showGitHub={false} showDemo={false} name="Spotify Analysis"
            ...
            <Projectcard showGitHub={true} showDemo={false} name="Portfolio Website" url="https://github.com/dtnguyen0/portfolio"
